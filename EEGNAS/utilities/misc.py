...
def label_by_idx(idx, dataset=None):
    if dataset is None:
        dataset = global_vars.get('dataset')
    labels = {'BCI_IV_2a': ['Left Hand', 'Right Hand', 'Foot', 'Tongue'],
              'BCI_IV_2b': ['Left Hand', 'Right Hand'],
              'TUH': ['Normal', 'Abnormal'],
              'netflow_asflow': [f'hour {17+i}:00' for i in range(5)]}
    return labels[dataset][idx]


def eeg_label_by_idx(idx, dataset=None):
    if dataset is None:
        dataset = global_vars.get('dataset')
    labels = {'BCI_IV_2b': ['C3', 'Cz', 'C4'],
              ...
              'netflow_asflow': ["1299","2914","174","3257","6762","6453","3356","33891","6939","6461","1273","5511","15169","20940","2906","16509","32934","15133","22822","202818","16276","46489"]}
